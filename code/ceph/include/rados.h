...
#define CEPH_OSD_LICENSE_OFFLINE      (1<<12) /* unable to connect to platform */
#define CEPH_OSD_LICENSE_OFFLINE_LONG (1<<13) /* offlile for more than 7 days */
#define CEPH_OSD_LICENSE_NEAR_EXPIRE  (1<<14) /* license is near to expire */
#define CEPH_OSD_LICENSE_SOON_EXPIRE  (1<<15) /* license will expire within 3 days */
#define CEPH_OSD_SLOW_DISK_DROP       (1<<16) /* drop osd */
...
enum {
	...
	CEPH_OSD_FLAG_SKIP_CACHE =   0x4000000,  /* skip cache logic */
};
