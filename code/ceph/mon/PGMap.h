...
public:
  ...
  int get_pool_used_percent(const OSDMap &osd_map, int64_t poolid, double &used_percent) const;
  ...
  int64_t get_rule_used_space(const OSDMap &osd_map, int ruleno) const;
