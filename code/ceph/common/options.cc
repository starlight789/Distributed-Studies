...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    .add_service({"mon", "mds", "osd", "mgr", "rgw"}),
    ...
    // license
    Option("license_addr_ip", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("")
    .set_description("the ip of platform"),

    Option("license_addr_port", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(8767)
    .set_description("the port of platform"),

    Option("license_offline_error", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(7)
    .set_description("cluster status changed to error if offline for more than 7 days"),

    Option("license_expire_warn", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("warn if the license will expire within 10 days"),

    Option("license_expire_error", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(3)
    .set_description("cluster status changed to error if the license will expire within 3 days"),

    // slow disk check
    Option("mon_slow_disk_check_enable_drop_disk", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("enable mon to drop osd when osd reports that there be slow disks needed to drop"),

    Option("osd_slow_disk_check_enable", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("enable slow disk check"),

    Option("osd_slow_disk_check_level1_hdd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(30.0)
    .set_description("we divides svctm (service time, ms) into three differnet levels: level0/level1/level2, "
                     "each leval corresponds to a different weighting value, the values are 0/1/2."),

    Option("osd_slow_disk_check_level1_ssd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(20.0)
    .set_description("sata ssd slow disk level 1 (ms)"),

    Option("osd_slow_disk_check_level1_nvme", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(10.0)
    .set_description("nvme ssd slow disk level 1 (ms)"),

    Option("osd_slow_disk_check_level2_hdd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(60.0)
    .set_description("sata hdd slow disk level 2 (ms)"),

    Option("osd_slow_disk_check_level2_ssd", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(40.0)
    .set_description("sata ssd slow disk level 2 (ms)"),

    Option("osd_slow_disk_check_level2_nvme", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(20.0)
    .set_description("nvme ssd slow disk level 2 (ms)"),

    Option("osd_slow_disk_check_min_period", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("how often do osd read disk state"),

    Option("osd_slow_disk_check_warn_interval", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(180)
    .set_description("slow disk alarm cycle, osd reports the slow disk state to MON onece a cycle."),

    Option("osd_slow_disk_check_warn_long_interval", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1800)
    .set_description("if a osd in slow disk state for more than osd_slow_disk_check_warn_long_interval "
                     " seconds, MON will warn this osd stuck in slow disk for too long"),

    Option("osd_slow_disk_check_drop_interval", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10800)
    .set_description("if a osd in the slow disk state for more than osd_slow_disk_check_drop_interval "
                     "seconds, mon will try to drop it (second)"),

    Option("osd_slow_disk_warn_percent", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(80)
    .set_description("threshold for warning"),

    Option("osd_slow_disk_warn_long_percent", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(20)
    .set_description("threshold for report osd stuck in slow disk state for too long"),

    Option("osd_slow_disk_drop_percent", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(20)
    .set_description("threshold for osd report to mon needs to drop slow disk"),

    Option("osd_slow_disk_min_ops_each_period", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("the svctm of slow disk may be very small, because its IO pressure is low. "
                     "Therefore, we count this period only when the number of ops is greater "
                     "than this value"),

    Option("osd_slow_disk_drop_osd_max_pool_used_percent", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.80)
    .set_description("the mon can not drop disk when the usage of the pool containing this "
                     "osd exceeds this value"),

    Option("osd_slow_disk_debug_inject_slow_op", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("inject slow scvtm for debug"),

    Option("osd_slow_disk_debug_inject_slow_op_range_start", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(100.0)
    .set_description("the lowest value of the injected scvtm"),

    Option("osd_slow_disk_debug_inject_slow_op_range_end", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(300.0)
    .set_description("the max value of the injected scvtm"),

    Option("osd_slow_disk_debug_inject_slow_op_percent", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("percentage of slow scvtm injected"),
    ...
    .set_default(true)
    .set_description("try to calculate PG upmaps more aggressively, e.g., by doing a fairly "
                     "exhaustive search of existing PGs that can be unmapped or upmapped"),

    Option("osd_calc_pg_upmaps_aggressively_fast", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("Prevent very long (>10 minutes) calculations in some extreme cases "
                     "(applicable only to aggressive mode)"),

    Option("osd_calc_pg_upmaps_local_fallback_retries", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(100)
    .set_description("Maximum number of PGs we can attempt to unmap or upmap for a specific overfull"
    ...
    Option("objectstore_cache_shard_num", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(64)
    .set_description("number of cache shards"),

    Option("try_osd_merge_ops", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("try to merge ops and submit ops in batches"),

    Option("osd_merge_batch_max_size", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(48)
    .set_description("the max number of ops in one merged op"),

    Option("osd_debug_merge_inject_read_error", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("inject error for test, percentage [0~100]"),

    Option("osd_debug_merge_inject_write_error", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("inject error for test, percentage [0~100]"),
    ...
    Option("osd_scrub_unittest", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("To allow the command from user to exec auto_repair"),
    ...
    Option("osd_debug_inject_op_timeout", Option::TYPE_UINT, Option::LEVEL_DEV)
    .set_default(0)
    .set_description("For debug, inject slow requests"),

    Option("osd_debug_inject_op_timeout_percentage", Option::TYPE_UINT, Option::LEVEL_DEV)
    .set_default(0)
    .set_description(""),

    Option("osd_client_op_timeout", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(300)
    .set_description("osd client ops timeout in seconds"),

    Option("osd_loop_before_reset_tphandle", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(64)
    .set_description(""),

    Option("osd_recovery_begin_time", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("00:00:00")
    .set_description("Restrict recovery to this time of the day or later, the format "
                     "is HH:MM:SS, H is hour, M is minute, S is second. \"00:00:00\", \"23:59:59\","
                     "\"01:01:59\", etc.")
    .add_see_also("osd_recovery_end_time"),

    Option("osd_recovery_end_time", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("23:59:59")
    .set_description("Restrict recovery to this time of the day earlier than this")
    .add_see_also("osd_recovery_begin_time"),

    Option("osd_recovery_begin_weekday", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("Restrict recvoery to this day of the week or later")
    .set_long_description("0 or 7 = Sunday, 1 = Monday, etc.")
    .add_see_also("osd_recovery_end_weekday"),

    Option("osd_recovery_end_weekday", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(7)
    .set_description("Restrict recovery to days of the week earlier than this")
    .set_long_description("0 or 7 = Sunday, 1 = Monday, etc.")
    .add_see_also("osd_recovery_end_weekday"),

    Option("osd_backfill_begin_time", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("00:00:00")
    .set_description("Restrict backfill to this time of the day or later, the format "
                     "is HH:MM:SS, H is hour, M is minute, S is second. \"00:00:00\", \"23:59:59\","
                     "\"01:01:59\", etc.")
    .add_see_also("osd_backfill_end_time"),

    Option("osd_backfill_end_time", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("23:59:59")
    .set_description("Restrict backfill to this time of the day earlier than this")
    .add_see_also("osd_backfill_begin_time"),

    Option("osd_backfill_begin_weekday", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("Restrict backfill to this day of the week or later")
    .set_long_description("0 or 7 = Sunday, 1 = Monday, etc.")
    .add_see_also("osd_backfill_end_weekday"),

    Option("osd_backfill_end_weekday", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(7)
    .set_description("Restrict backfill to days of the week earlier than this")
    .set_long_description("0 or 7 = Sunday, 1 = Monday, etc.")
    .add_see_also("osd_backfill_end_weekday"),

    Option("osd_recovery_skip_time_limit_when_degraded", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("skip time limit when pg is degraded or undersize"),

    Option("osd_backfill_skip_time_limit_when_degraded", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("skip time limit when pg is degraded or undersize"),

    Option("osd_recovery_speed_self_adaption", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("enable auto-adjust recovery speed"),

    Option("osd_recovery_speed_adaption_period", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(2)
    .set_description("the period of recovery speed auto-adjust, the unit is seconds")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_read_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(15)
    .set_description("when osd is hdd and the client read requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_read_sata_ssd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(8)
    .set_description("when osd is sata ssd and the client read requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_read_nvme", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(5)
    .set_description("when osd is nvme and the client read requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_write_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(65)
    .set_description("when osd is hdd and the client write requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_write_sata_ssd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("when osd is sata ssd and the client write requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_write_nvme", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(5)
    .set_description("when osd is nvme and the client write requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_rwrite_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(65)
    .set_description("when osd is hdd and the client rw requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_rwrite_sata_ssd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("when osd is sata ssd and the client rw requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_increase_rwrite_nvme", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(5)
    .set_description("when osd is nvme and the client rw requests take less than this value, we increase the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_read_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(25)
    .set_description("when osd is hdd and the client read requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_read_sata_ssd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(15)
    .set_description("when osd is sata ssd and the client read requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_read_nvme", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("when osd is nvme and the client read requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_write_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(95)
    .set_description("when osd is hdd and the client write requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_write_sata_ssd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(15)
    .set_description("when osd is sata ssd and the client write requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_write_nvme", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("when osd is nvme and the client write requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_rwrite_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(95)
    .set_description("when osd is hdd and the client rw requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_rwrite_sata_ssd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(15)
    .set_description("when osd is sata ssd and the client rw requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_speed_decrease_rwrite_nvme", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_description("when osd is nvme and the client rw requests take more than this value, we decrease the "
                     "speed of recovery (ms)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_recovery_gap_sleep", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.2)
    .set_description("the sleep duration for each adjustment (second)")
    .add_see_also("osd_recovery_speed_self_adaption"),

    Option("osd_max_backfills_gap", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("the value of osd_max_backfills adjusted at each step")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_max_backfills"}),

    Option("osd_recovery_max_active_gap", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("the value of osd_recovery_max_active adjusted at each step")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_recovery_max_active"}),

    Option("osd_recovery_adaption_max_backfills", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(32)
    .set_description("the max value of osd_max_backfills when enable recovery auto-adjust")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_max_backfills"}),

    Option("osd_recovery_adaption_max_active", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(64)
    .set_description("the max value of osd_max_backfills when enable recovery auto-adjust")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_recovery_max_active"}),

    Option("osd_recovery_adaption_lowest_sleep", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("the minimum value of osd_recovery_sleep_x when enable recovery auto-adjust")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_recovery_sleep"}),

    Option("osd_recovery_adaption_min_backfills", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("the minimum value of osd_max_backfills when enable recovery auto-adjust")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_max_backfills"}),

    Option("osd_recovery_adaption_min_active", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(3)
    .set_description("the minimum value of osd_max_backfills when enable recovery auto-adjust")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_recovery_max_active"}),

    Option("osd_recovery_adaption_max_sleep", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(2)
    .set_description("the max value of osd_recovery_sleep_x when enable recovery auto-adjust")
    .add_see_also({"osd_recovery_speed_self_adaption", "osd_recovery_sleep"}),

    Option("osd_recovery_pause_when_client_op_inflight", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("stop recovery and backfill when the osd have client requests")
    .add_see_also("osd_recovery_pause_max_iops"),

    Option("osd_recovery_pause_max_iops", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(8)
    .set_description("if osd_recovery_pause_when_client_op_inflight is ture and the number of client "
                     "requests is greater than this value, we pause recovery and backfill")
    .add_see_also("osd_recovery_pause_when_client_op_inflight"),
    ...
    Option("rocksdb_high_pri_pool_ratio", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_default(0.0)
    .set_description("The ratio of capacity reserved for high priority blocks, it's used by filter and index"),

    Option("rocksdb_cache_strict_capacity_limit", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("strictly limit the capacity of rocksdb cache"),
    ...
    Option("bdev_poweroff_safe", Option::TYPE_BOOL, Option::LEVEL_DEV)
    .set_default(true)
    .set_description("require flush data to the physical disk"),

    Option("bdev_poweroff_force_flush_interval", Option::TYPE_UINT, Option::LEVEL_DEV)
    .set_default(2000)
    .set_description("when bdev_poweroff_safe is set as false, flushing to the disk once in this "
                     "interval forcibly (ms)"),
    ...
    Option("bluestore_volume_selection_db_reserved", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(2_G)
    .set_description("The reserved storage on the db disk, avoiding the db disk is used up by higher level sst files"),
   ...
   Option("bluestore_deferred_write_min_percentage", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(10)
    .set_flag(Option::FLAG_RUNTIME)
    .set_description("allow deferred write only when the part that needs to be defer written is "
                     "big than bluestore_deferred_write_min_percentage percent of the total write size"),
    ...
    .set_default("compression_per_level=kNoCompression:kNoCompression:kNoCompression:kLZ4Compression:kLZ4Compression:kLZ4Compression,"
                 "compaction_style=kCompactionStyleLevel,max_background_flushes=4,compaction_threads=16,max_background_compactions=12,"
                 "max_subcompactions=1,recycle_log_file_num=32,write_buffer_size=67108864,min_write_buffer_number_to_merge=2,"
                 "max_write_buffer_number=32,level0_file_num_compaction_trigger=8,level0_slowdown_writes_trigger=32,"
                 "level0_stop_writes_trigger=64,num_levels=8,target_file_size_base=67108864,max_bytes_for_level_base=536870912,"
                 "max_bytes_for_level_multiplier=8,flusher_threads=4,compaction_readahead_size=2097152,allow_concurrent_memtable_write=true,"
                 "enable_write_thread_adaptive_yield=true,writable_file_max_buffer_size=65536")
  ...
  Option("bluestore_throttle_cost_per_io_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    ...
    Option("bluestore_force_use_buffer_io", Option::TYPE_BOOL, Option::LEVEL_DEV)
    .set_default(false)
    .set_description("force BlueStore to use buffered io"),
    ...
    Option("bluestore_shard_finishers", Option::TYPE_INT, Option::LEVEL_DEV)
    .set_default(2)
    .set_description(""),
  ...
  .set_min_max((int64_t)PerfCountersBuilder::PRIO_DEBUGONLY,
    ...
    .set_default("status balancer iostat volumes")
    .set_flag(Option::FLAG_NO_MON_UPDATE)
    .set_flag(Option::FLAG_CLUSTER_CREATE)
    .add_service("mon")
...
std::vector<Option> get_rgw_options() {
  return std::vector<Option>({
    ...
    Option("rgw_rados_read_flag", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("bit mask values to control rados reading, see librados.h for options"),
    ...
    Option("rgw_bucket_namespace_enable", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("Enable bucket namespce."),

    Option("rgw_bucket_namespace_disable_force", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("Force disable bucket namespce."),

    Option("rgw_namespace_head_cheap", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("If this option is true and bucket have namespace, head_obj only return size "
                     "and mtime"),

    Option("rgw_namespace_disable_object_policy", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("If the bucket namespace is enable, don't check object policy when head "
                     " object or directory."),
    ...
    .set_default("s3, s3website, swift, swift_auth, admin, bos")
    ...
    Option("rgw_enable_skip_cachepool", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("Rgw can skip cache pool to operate obj in data pool directly.")
    .set_long_description(
        "When file is too large, the RGW can put tail objects to data pool directly "
        "and only operate head_obj in cache pool."),

    Option("rgw_file_shuntflow_size", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(2_M)
    .set_description("Rgw can directly put tail objects to tail pool, "
                     "when file size is small as shuntflow_size"),
    ...
    Option("rgw_s3_url_prefix", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("s3")
    .set_description("S3 URL prefix")
    .set_long_description("The URL path prefix for s3 requests."),
    ...
    Option("rgw_s3_auth_use_iam", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description(""),
    ...
    Option("rgw_bos_url_prefix", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("bos")
    .set_description("Path prefix to be used for accessing RGW RESTful bos API."),
    ...
    Option("rgw_readop_usage_whitelist", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("")
    .set_description("whitelist of remote client for readop usage.")
    .set_long_description(
        "If the ipaddr of remote client is in whitelist，rgw_usage will not record read ops and bytes_sent."
        "The rgw_readop_usage_whitelist should be named as xxx.xxx.xxx.xxx/24 or xxx.xxx.xxx.xxx, "
        "and be separate by comma.(e.g., 10.190.78.0/24,10.190.77.28)"
        ""
        ),
    ...
    Option("rgw_access_log_file", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("")
    .set_description("path to rgw access log file")
    .set_long_description("if set, RGW will print access log to the path."),
    ...
    Option("rgw_usage_entry_add_threshold", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(60)
    .set_description("Interval (in seconds) for usage_map update entry"),
    ...
    Option("rgw_usage_log_tick_trim_interval", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(1_day)
    .set_description("Number of days between usage log trim cycles"),

    Option("rgw_usage_log_trim_time_wait", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(7_day)
    .set_description("Number of days before usage log trimmed"),

    Option("rgw_usage_log_readop_trim_time_wait", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(30_day)
    .set_description("Number of days before readop usage log trimme"),
    ...
    Option("rgw_use_bos_bucket_names", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("RGW enable bos bucket name rules"),

    Option("rgw_encrypt_ip_into_request_id", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("Encrypt ip addr into request id, same with bos"),
    ...
    Option("rgw_bucket_clear_max_aio", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(32)
    .set_description("Max number of concurrent RADOS requests when handling bucket obj remove."),
    ...
    Option("rgw_num_async_request_threads", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(32)
    .set_description("Number of concurrent async request operations in rgw_async_preocessor")
    .set_long_description(
        "Determines the size of the thread pool for the RGW async processor, which handles "
        "parallel execution of asynchronous tasks. Adjusting this value can affect performance "
    ...
    Option("rgw_crypt_enable", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description(""),
    ...
    Option("rgw_list_max_attempt_times", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(3)
    .set_description("Max attempt times for ordered list objects, 0 means unlimited")
    .set_long_description(
        "Loop number in ordered bucket listing. If bucket with huge number of objects "
        "and complex dir path, list bucket with delimiter can results too much list "
        "request to rados to get total list for current dir. This number can avoid "
        "this condition which will return portion list instead of total list."),
    ...
    Option("rgw_delay_remove_head_obj", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("Add removed head_obj to gc list instead of delete it directly")
    .set_long_description("If this option is true, delete object will just set RGW_ATTR_DELETED "
        "attribute on head_obj, and add it to gc chain with precisely tag and mtime. "
        "When head this object, return 404 when this attribute is equal to true. "
        "We suggest you set this option to true in multisite situation. By set it to true, "
        "we can retain head_obj temporarily. Thus we can get removal operation's mtime to ensure "
        "consistency between multiple clusters in concurrency operations of updating the same object."),
    ...
    Option("rgw_node_bandwidth_limit", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(-1)
    .set_description("rgw node bandwidth limit"),

    Option("rgw_node_qps_limit", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(-1)
    .set_description("rgw node qps limit"),

    Option("rgw_enable_list_rgw", Option::TYPE_BOOL, Option::LEVEL_DEV)
    .set_default(false)
    .set_description("Enable client get rgw list by restful api"),

    Option("rgw_append_timeout", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(120)
    .add_service("rgw")
    .set_description("Appending to same offset after rgw_apend_timeout")
    .set_long_description("After update head_obj, radosgw program is down before "
                          "complete append request, which means not update head_obj "
                          "in the end. After rgw_append_timeout seconds, client can "
                          "retry append data to the same offset."),

    Option("rgw_sync_data_awake_interval_sec", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(60)
    .set_description("interval to check bucket stats, update stats and notify corresponding zone if need"),

    Option("rgw_abcstore_proxy_address", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("127.0.0.1:8123")
    .set_description("proxy server address, for forward iam or timg request"),

    Option("rgw_abcstore_proxy_connect_number", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(100)
    .set_description("total connected numbers to abcstore_proxy which is maintained by connection pool"),

    Option("rgw_abcstore_proxy_connect_retry", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(3)
    .set_description("retry times to connect to abcstore_proxy"),

    Option("rgw_worm_debug_interval", Option::TYPE_INT, Option::LEVEL_DEV)
    .set_default(-1)
    .set_description(""),

    Option("rgw_bos_worm_expiration_time", Option::TYPE_INT, Option::LEVEL_DEV)
    .set_default(86400)
    .set_description("bos worm expiration time, have to complete this object lock in this time."),

    Option("rgw_bos_monitor_address", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("bosadmin.abcstackint.com:8889")
    .set_description("bos_monitor address, for forward activate/passivate bcm resource"),

    Option("rgw_bos_monitor_connect_number", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("total connected numbers to bos_monitor which is maintained by connection pool"),

    Option("rgw_default_location", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("")
    .set_description("Bucket default location"),

    Option("rgw_play_service", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("bce:bos")
    .set_description("Radosgw plays service in iam"),

    Option("rgw_with_bcm_restrict", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("create&delete bucket will be continued only if notify "
        "resource to bcm successfully"),

    Option("rgw_iam_admin_read_ak", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("ak")
    .set_description("admin_read account access key")
    .set_long_description("Image process need to generate presign url for timg, which need "
                     "this to fetch picture. So, presign url use admin_read account, "
                     "which is authorized by IAM."),

    Option("rgw_iam_admin_read_sk", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("sk")
    .set_description("admin_read account secret key")
    .add_see_also("rgw_iam_admin_read_ak"),

    Option("rgw_max_copy_obj_concurrent_io", Option::TYPE_INT, Option::LEVEL_DEV)
    .set_default(10)
    .set_description("the async io number processed meanwhile"),

    Option("rgw_bos_format_access_log", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("access log format consistent with bos nginx, which results "
                     "in accuracy of ts reduced from milliseconds to seconds."),
    Option("rgw_kms_address", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("kms.abcstackint.com:80")
    .set_description("kms address, connect to kms server"),

    Option("rgw_kms_connect_number", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(100)
    .set_description("total connected numbers to kms server which is maintained by connection pool"),

    Option("rgw_kms_connect_retry", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(3)
    .set_description("retry times to connect to kms server"),

    Option("rgw_kms_admin_user", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("admin")
    .set_description("local user used kms should be usd  admin user"),

    Option("rgw_abcstore_multi_region", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("rgw multi region, if true, apply databse."),

    Option("rgw_sync_bucket_clear_interval_sec", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(86400)
    .set_description("slave rgw bucket clear interval to followers"),

    Option("rgw_sync_bucket_clear_bypass_gc", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("slave rgw bucket clear rgw object bypass gc"),

    Option("rgw_multisite_bucket_clear_flag", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("rgw multisite bucket flag. if true, will remove bucket shard and bucket.instance "
                     "on both master and slave when remove bucket on master."),

    Option("rgw_default_api_bos", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(false)
    .set_description("anonymous user choose default bos api"),

    Option("rgw_mirror_data_window_size", Option::TYPE_SIZE, Option::LEVEL_ADVANCED)
    .set_default(1_M)
    .set_description("RGW mirroring fetch source data window size")
    .set_long_description("Size of cached source data locally when mirroring "
                          "back to source, make it streaming via a sliding window"),

    Option("rgw_mirror_url_blacklist", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default("")
    .set_description("blacklist of ip and domain that cann't been configured in mirror")
    .set_long_description("support ip network segment or domain, separated by comma, "
        "e.g. 10.190.0.0/16,bos.hk.bce-internal.baidu.com"
        ),
    Option("rgw_signature_v4", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .set_description("Signature request with AWS version 4"),
    Option("rgw_default_trash_dir", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_default(".trash")
    .set_description("default bucket trash dir, if set buckcket trash but "
                      "don't set trash dir, use default bucket trash dir."),
  });
