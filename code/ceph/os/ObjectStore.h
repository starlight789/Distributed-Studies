...
public:
 ...
 public:
  ...
  // gets all hardware devices in use, return a list <devices name, is rotational>
  // e.g. <'sda', true>
  virtual int get_devices_and_types(map<string, bool> &ls) {
    return -EOPNOTSUPP;
  }

  // gets the hardware device of data, return a pair<devices name, is rotational>
  // e.g. <'sda', true>
  virtual int get_data_device_and_type(pair<string, bool> &device) {
    return -EOPNOTSUPP;
  }
