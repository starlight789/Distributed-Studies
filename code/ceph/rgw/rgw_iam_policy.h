...
static constexpr std::uint64_t s3GetObject =  1;
static constexpr std::uint64_t s3GetObjectVersion =  2;
static constexpr std::uint64_t s3PutObject =  3;
static constexpr std::uint64_t s3GetObjectAcl =  4;
static constexpr std::uint64_t s3GetObjectVersionAcl =  5;
static constexpr std::uint64_t s3PutObjectAcl =  6;
static constexpr std::uint64_t s3PutObjectVersionAcl =  7;
static constexpr std::uint64_t s3DeleteObject =  8;
static constexpr std::uint64_t s3DeleteObjectVersion =  9;
static constexpr std::uint64_t s3ListMultipartUploadParts =  10;
static constexpr std::uint64_t s3AbortMultipartUpload =  11;
static constexpr std::uint64_t s3GetObjectTorrent =  12;
static constexpr std::uint64_t s3GetObjectVersionTorrent =  13;
static constexpr std::uint64_t s3RestoreObject =  14;
static constexpr std::uint64_t s3CreateBucket =  15;
static constexpr std::uint64_t s3DeleteBucket =  16;
static constexpr std::uint64_t s3ListBucket =  17;
static constexpr std::uint64_t s3ListBucketVersions =  18;
static constexpr std::uint64_t s3ListAllMyBuckets =  19;
static constexpr std::uint64_t s3ListBucketMultipartUploads =  20;
static constexpr std::uint64_t s3GetAccelerateConfiguration =  21;
static constexpr std::uint64_t s3PutAccelerateConfiguration =  22;
static constexpr std::uint64_t s3GetBucketAcl =  23;
static constexpr std::uint64_t s3PutBucketAcl =  24;
static constexpr std::uint64_t s3GetBucketCORS =  25;
static constexpr std::uint64_t s3PutBucketCORS =  26;
static constexpr std::uint64_t s3GetBucketVersioning =  27;
static constexpr std::uint64_t s3PutBucketVersioning =  28;
static constexpr std::uint64_t s3GetBucketRequestPayment =  29;
static constexpr std::uint64_t s3PutBucketRequestPayment =  30;
static constexpr std::uint64_t s3GetBucketLocation =  31;
static constexpr std::uint64_t s3GetBucketPolicy =  32;
static constexpr std::uint64_t s3DeleteBucketPolicy =  33;
static constexpr std::uint64_t s3PutBucketPolicy =  34;
static constexpr std::uint64_t s3GetBucketNotification =  35;
static constexpr std::uint64_t s3PutBucketNotification =  36;
static constexpr std::uint64_t s3GetBucketLogging =  37;
static constexpr std::uint64_t s3PutBucketLogging =  38;
static constexpr std::uint64_t s3GetBucketTagging =  39;
static constexpr std::uint64_t s3PutBucketTagging =  40;
static constexpr std::uint64_t s3GetBucketWebsite =  41;
static constexpr std::uint64_t s3PutBucketWebsite =  42;
static constexpr std::uint64_t s3DeleteBucketWebsite =  43;
static constexpr std::uint64_t s3GetLifecycleConfiguration =  44;
static constexpr std::uint64_t s3PutLifecycleConfiguration =  45;
static constexpr std::uint64_t s3PutReplicationConfiguration =  46;
static constexpr std::uint64_t s3GetReplicationConfiguration =  47;
static constexpr std::uint64_t s3DeleteReplicationConfiguration =  48;
static constexpr std::uint64_t s3GetObjectTagging =  49;
static constexpr std::uint64_t s3PutObjectTagging =  50;
static constexpr std::uint64_t s3DeleteObjectTagging =  51;
static constexpr std::uint64_t s3GetObjectVersionTagging =  52;
static constexpr std::uint64_t s3PutObjectVersionTagging =  53;
static constexpr std::uint64_t s3DeleteObjectVersionTagging =  54;
static constexpr std::uint64_t s3PutBucketNamespace =  55;
static constexpr std::uint64_t s3GetBucketNamespace =  56;
static constexpr std::uint64_t s3DeleteBucketNamespace =  57;
static constexpr std::uint64_t s3PutBucketObjectLockConfiguration = 58;
static constexpr std::uint64_t s3GetBucketObjectLockConfiguration = 59;
static constexpr std::uint64_t s3PutObjectRetention = 60;
static constexpr std::uint64_t s3GetObjectRetention = 61;
static constexpr std::uint64_t s3PutObjectLegalHold = 62;
static constexpr std::uint64_t s3GetObjectLegalHold = 63;
static constexpr std::uint64_t s3BypassGovernanceRetention = 64;
static constexpr std::uint64_t s3DeleteObjectAcl = 65;
static constexpr std::uint64_t s3DeleteBucketLogging = 66;
static constexpr std::uint64_t s3PutImageStyle = 67;
static constexpr std::uint64_t s3GetImageStyle = 68;
static constexpr std::uint64_t s3PutImageProtection = 69;
static constexpr std::uint64_t s3GetImageProtection = 70;
static constexpr std::uint64_t s3PostObject = 71;
static constexpr std::uint64_t s3CopyObject = 72;
static constexpr std::uint64_t s3ListParts = 73;
static constexpr std::uint64_t s3PutBucketCors = 74;
static constexpr std::uint64_t s3GetBucketCors = 75;
static constexpr std::uint64_t s3GetBucket = 76;
static constexpr std::uint64_t s3HeadBucket = 77;
static constexpr std::uint64_t s3GetObjectMeta = 78;
static constexpr std::uint64_t s3ListObjects = 79;
static constexpr std::uint64_t s3ListMultiObjects = 80;
static constexpr std::uint64_t bosRead = 81;
static constexpr std::uint64_t bosList = 82;
static constexpr std::uint64_t bosWrite = 83;
static constexpr std::uint64_t bosModify = 84;
static constexpr std::uint64_t bosFullControl = 85;
static constexpr std::uint64_t s3GetBucketMirroring =  86;
static constexpr std::uint64_t s3PutBucketMirroring =  87;
static constexpr std::uint64_t s3GetBucketStorageClass = 88;
static constexpr std::uint64_t s3PutBucketStorageClass = 89;
static constexpr std::uint64_t s3PutBucketEncryption = 90;
static constexpr std::uint64_t s3GetBucketEncryption = 91;
static constexpr std::uint64_t s3DeleteBucketEncryption = 92;
static constexpr std::uint64_t s3InitBucketObjectLockConfiguration = 93;
static constexpr std::uint64_t s3DeleteBucketObjectLockConfiguration = 94;
static constexpr std::uint64_t s3CompleteBucketObjectLockConfiguration = 95;
static constexpr std::uint64_t s3ExtendBucketObjectLockConfiguration = 96;
static constexpr std::uint64_t s3All = 97;
static constexpr std::uint64_t s3Count = s3All + 1;

using Action_t = bitset<s3Count>;
...
static const Action_t s3AllValue = set_cont_bits<s3Count>(0, s3All);

namespace {
inline int op_to_perm(std::uint64_t op) {
  switch (op) {
  case s3GetObject:
  case s3GetObjectMeta:
  ...
  case s3DeleteBucketNamespace:
  case s3PutBucketNamespace:
  case s3PutBucketObjectLockConfiguration:
  case s3DeleteBucketLogging:
  case s3PutBucketEncryption:
  case s3DeleteBucketEncryption:
  case s3PutImageStyle:
  case s3PutImageProtection:
  case s3PutBucketMirroring:
  case s3InitBucketObjectLockConfiguration:
  case s3CompleteBucketObjectLockConfiguration:
  case s3ExtendBucketObjectLockConfiguration:
