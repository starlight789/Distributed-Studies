...
public:
  ...
  void set_range_explicited(bool _range_explicited) {
    range_explicited = _range_explicited;
  }
  ...
  struct get_obj_params {
    ...
    map<string, string>* explicit_headers = nullptr;
    map<string, string>* explicit_params = nullptr;
  };
  ...
  int get_obj(const rgw_user& uid, req_info *info /* optional */, const rgw_obj& obj,
              ...
              map<string, string>* headers = nullptr, map<string, string>* params = nullptr);
