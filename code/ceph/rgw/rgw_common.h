...
#define RGW_AMZ_STORAGE_CLASS  RGW_AMZ_PREFIX "storage-class"
#define RGW_BCE_STORAGE_CLASS "x-bce-storage-class"
#define RGW_BCE_META_PREFIX RGW_ATTR_PREFIX "x-bce-meta-"
...
#define RGW_ATTR_LOGGING  RGW_ATTR_PREFIX "logging"
#define RGW_ATTR_ETAG    	RGW_ATTR_PREFIX "etag"
#define RGW_ATTR_IMAGE_STYLE RGW_ATTR_PREFIX "image_style"
#define RGW_ATTR_IMAGE_PROTECTION RGW_ATTR_PREFIX "image_protection"
...
#define RGW_ATTR_QPS_LIMIT      RGW_ATTR_PREFIX "qps_limit"
#define RGW_ATTR_BANDWIDTH_LIMIT    RGW_ATTR_PREFIX "bandwidth_limit"
#define RGW_ATTR_NOTIFICATION   RGW_ATTR_PREFIX "notification"
#define RGW_ATTR_DEDICATED      RGW_ATTR_PREFIX "dedicated"
#define RGW_ATTR_TARGET_OBJECT  RGW_ATTR_PREFIX "target_object"
#define RGW_ATTR_TARGET_BUCKET  RGW_ATTR_PREFIX "target_bucket"
#define RGW_ATTR_TARGET_TENANT  RGW_ATTR_PREFIX "target_bucket_tenant"
...
#define RGW_NAMESPACE_HEAD_ATTR RGW_ATTR_META_PREFIX "namespace"
...
#define RGW_ATTR_AFFILIATION    RGW_ATTR_PREFIX "affiliation"
...
#define RGW_ATTR_TARGET_SIZE    RGW_ATTR_PREFIX "target_size"
#define RGW_ATTR_APPEND_TIMEOUT RGW_ATTR_PREFIX "append_timeout"
#define RGW_ATTR_REQUEST_ID     RGW_ATTR_PREFIX RGW_AMZ_PREFIX "request-id"
...
#define RGW_ATTR_CRYPT_ALGORITHM  RGW_ATTR_CRYPT_PREFIX "algorithm"
#define RGW_ATTR_CRYPT_KEYMD5     RGW_ATTR_CRYPT_PREFIX "keymd5"
#define RGW_ATTR_CRYPT_SSE_C_KEY  RGW_ATTR_CRYPT_PREFIX "sse_c_key"
#define RGW_ATTR_CRYPT_KEYID      RGW_ATTR_CRYPT_PREFIX "keyid"
#define RGW_ATTR_CRYPT_KEYSEL     RGW_ATTR_CRYPT_PREFIX "keysel"
#define RGW_ATTR_CRYPT_CDK        RGW_ATTR_CRYPT_PREFIX "cdk"

#define RGW_ATTR_DELETED        RGW_ATTR_PREFIX "deleted"
#define RGW_ATTR_BAN            RGW_ATTR_PREFIX "ban"
#define RGW_ATTR_VARY           RGW_ATTR_PREFIX "vary"
#define RGW_ATTR_RENAME_PREFIX  RGW_ATTR_PREFIX "rn."
#define RGW_ATTR_RENAME_SOURCE  RGW_ATTR_RENAME_PREFIX "s."
#define RGW_ATTR_RENAME_DEST    RGW_ATTR_RENAME_PREFIX "d."


#define RGW_ATTR_MIRRORING   RGW_ATTR_PREFIX "mirror"
#define RGW_ATTR_CONTENT_MD5 RGW_ATTR_PREFIX "md5"
...
#define ERR_NO_SUCH_OBJECT_LOCK_CONFIGURATION  2045
#define ERR_INVALID_RETENTION_PERIOD 2046
#define ERR_INVALID_IMAGE        2047
#define ERR_NO_IMAGE_PROTECTION  2048
#define ERR_USER_OBJECT_NUM_QUOTA_EXCEEDED   2049
#define ERR_USER_CAPACITY_QUOTA_EXCEEDED     2050
#define ERR_BUCKET_OBJECT_NUM_QUOTA_EXCEEDED 2051
#define ERR_BUCKET_CAPACITY_QUOTA_EXCEEDED   2052
#define ERR_ONLY_ALLOW_MODIFY    2053
#define ERR_NO_SUCH_IMAGE_STYLE  2054

#define ERR_NO_SUCH_MIRRORING     2055
#define ERR_MIRROR_SOURCE_INVALID 2056
#define ERR_MIRROR_SOURCE_DENY    2057
#define ERR_MIRROR_FAILED         2058
#define ERR_INVALID_BODY          2059
...
#define ERR_QPS_EXCEEDED                                 2216
#define ERR_OFFSET_INCORRECT                             2217
#define ERR_OBJECT_NOT_APPENDABLE                        2218
#define ERR_INVALID_BUCKET_STATE                         2219
#define ERR_CALLBACK_FAILED                              2221
#define ERR_NOTIFICATION_FAILED                          2222
#define ERR_NO_SUCH_BUCKET_NOTIFICATION                  2223
#define ERR_INVALID_SESSION_TOKEN                        2224
#define ERR_RENAME_CONFLICT                              2225
#define ERR_NO_SUCH_ENCRYPTION                           2226
#define ERR_INVALID_ENCRY_KMS_MK_ID                      2227
#define ERR_OBJ_LOCK_LOCKED                              2228
#define ERR_OBJ_LOCK_PROGRESS                            2229
#define ERR_OBJ_LOCK_EXPIRED                             2230
#define ERR_OBJ_NOT_LOCK                                 2231
#define ERR_NOT_ALLOW_SHORTEN_RETEN                      2232
#define ERR_OBJ_IMMUTABLE                                2233
#define ERR_NO_SUCH_TRASH_DIR                            2234
#define ERR_INVAL_TRASH_DIR_NAME                         2235

#define ERROR_BUCKET_NAMESPACE_NAME_CONFLICT   2250 // have the same name file or directory
#define ERROR_BUCKET_NAMESPACE_DIR_EXIST       2251 // directory alreay exist
#define ERROR_BUCKET_NAMESPACE_PARENT_NOEXIST  2252 // parent directory is not completed
#define ERROR_BUCKET_NAMESPACE_SET_NOT_ALLOWED 2253 // don't allow to set bucket namespace
#define ERROR_BUCKET_VERSION_SET_NOT_ALLOWED   2254 // don't allow to set bucket version
#define ERROR_BUCKET_DIR_NOT_EMPTY             2255 // directory not empty

#define ERR_MALFORMED_JSON                     2256
#define ERR_NO_SUCH_OBJECT_ACL                 2257
#define ERR_INAPPROPRIATE_JSON                 2258
#define ERR_NO_SUCH_CORS                       2259
#define ERR_NOTIFICATIONS_TOO_MANY             2260
#define ERR_NOTIFICATIONS_FORMAT_ERROR         2261
#define ERR_MAX_MESSAGE_LENGTH_EXCEEDED        2262
#define ERR_INVAILD_STATIC_WEBSITE_FORMAT      2263

#define ERR_BUSY_RESHARDING                    2300

#define ERR_NO_BUCKET_NAMESPACE                2350
#define CODE_NO_SUCH_USER_QUOTA                2351
#define CODE_NO_SUCH_BUCKET_QUOTA              2352
#define ERR_SYMLINK_TARGET_NOT_EXIST           2353
#define ERR_NOT_SYMLINK_OBJECT                 2354
#define ERR_FILE_ALREADY_EXISTS                2355
#define ERR_INVAILD_TARGET_TYPE                2356

#ifndef UINT32_MAX
#define UINT32_MAX (0xffffffffu)
#endif

#define RGW_BCE_PREFIX "x-bce-"
#define RGW_BCE_PROCESS RGW_BCE_PREFIX "process"
...
#define RGW_CLIENT_ID_SEPARATOR '&'
...
enum {
  ...
  l_rgw_put_before_put_meta,
  l_rgw_put_prepare_index,
  l_rgw_put_prepare_namespace,
  l_rgw_put_quick_prepare_namespace_lat,
  l_rgw_put_slow_prepare_namespace_lat,
  l_rgw_put_prepare_namespace_cls_op,
  l_rgw_put_prepare_namespace_cancel,

  l_rgw_put_head_meta,
  l_rgw_put_complete_index,
  l_rgw_put_complete_namespce,
  l_rgw_put_complete_namespce_cancel,
  l_rgw_put_lat,

  l_rgw_list_cls_list_namespace_lat,
  l_rgw_list_reuslt_process_namespace_lat,
  l_rgw_list_namespace_lat,
...
enum RGWOpType {
  ...
  RGW_OP_STAT_ACCOUNT,
  RGW_OP_LIST_BUCKET,
  RGW_OP_GET_BUCKET_STORAGE_CLASS,
  RGW_OP_PUT_BUCKET_STORAGE_CLASS,
  RGW_OP_GET_BUCKET_LOGGING,
  RGW_OP_PUT_BUCKET_LOGGING,
  RGW_OP_DELETE_BUCKET_LOGGING,
  ...
  RGW_OP_GET_BUCKET_NAMESPACE,
  RGW_OP_SET_BUCKET_NAMESPACE,
  RGW_OP_STAT_BUCKET,
  ...
  RGW_OP_BAN_CONTROL,
  RGW_OP_UNBAN_CONTROL,
  RGW_OP_PUT_BUCKET_NOTIFICATION,
  RGW_OP_GET_BUCKET_NOTIFICATION,
  RGW_OP_DELETE_BUCKET_NOTIFICATION,
  RGW_OP_PUT_BUCKET_QUOTA,
  RGW_OP_GET_BUCKET_QUOTA,
  RGW_OP_DELETE_BUCKET_QUOTA,
  RGW_OP_PUT_USER_QUOTA,
  RGW_OP_GET_USER_QUOTA,
  RGW_OP_DELETE_USER_QUOTA,
  ...
  RGW_OP_GET_LC,
  RGW_OP_DELETE_LC,
  RGW_OP_PUT_BUCKET_TRASH,
  RGW_OP_GET_BUCKET_TRASH,
  RGW_OP_DELETE_BUCKET_TRASH,
  RGW_OP_PUT_BUCKET_OBJ_LOCK,
  RGW_OP_INIT_BUCKET_OBJ_LOCK,
  RGW_OP_GET_BUCKET_OBJ_LOCK,
  RGW_OP_DELETE_BUCKET_OBJ_LOCK,
  RGW_OP_COMPLETE_BUCKET_OBJ_LOCK,
  RGW_OP_EXTEND_BUCKET_OBJ_LOCK,
  ...
  RGW_OP_PUT_SYMLINK_OBJ,
  RGW_OP_GET_SYMLINK_OBJ,
  /* rgw specific */
  ...
  RGW_OP_LIST_RGW,
  RGW_OP_PUT_IMAGE_STYLE,
  RGW_OP_DELETE_IMAGE_STYLE,
  RGW_OP_GET_IMAGE_STYLE,
  RGW_OP_LIST_IMAGE_STYLE,
  RGW_OP_PUT_IMAGE_PROTECTION,
  RGW_OP_DELETE_IMAGE_PROTECTION,
  RGW_OP_GET_IMAGE_PROTECTION,
  RGW_OP_PUT_BUCKET_MIRRORING,
  RGW_OP_GET_BUCKET_MIRRORING,
  RGW_OP_RENAME_OBJ,
};
...
struct RGWStorageClass {
  constexpr static const char* const STANDARD_HP = "STANDARD_HP";
  constexpr static const char* const STANDARD = "STANDARD";
  constexpr static const char* const STANDARD_IA = "STANDARD_IA";
  constexpr static const char* const ARCHIVE = "ARCHIVE";
};

struct rgw_placement_rule {
  std::string name;
  std::string storage_class;
  bool is_tail_rule = false;
  ...
  static const string get_canonical_storage_class(const string& sc) {
    if (sc.empty()) {
      return RGWStorageClass::STANDARD;
    }
    return sc;
  }
  ...
  std::string to_str_explicit() const {
    if (is_tail_rule) {
      return name + "/" + storage_class + "#tail_rule";
    }
    return name + "/" + storage_class;
  }

  void from_str_old(const std::string& s, char delim = '/') {
  ...
  void from_str(const std::string& s, char delim = '#') {
    size_t pos = s.find(delim);
    if (pos == std::string::npos) {
      from_str_old(s);
      is_tail_rule = false;
    ...
    from_str_old(s.substr(0, pos));
    is_tail_rule = (s.substr(pos + 1) == "tail_rule");
  }

  bool standard_storage_class() const {
    return storage_class.empty() || storage_class == RGWStorageClass::STANDARD;
  }
};
...
enum RGWBucketNamespaceType {
  BUCKET_NAMESPACE_DISABLE = 0,
  BUCKET_NAMESPACE_ENABLE = 1,
};
...
inline ostream& operator<<(ostream& out, const RGWBucketNamespaceType &namespace_type)
{
  switch (namespace_type) {
    case BUCKET_NAMESPACE_DISABLE:
      return out << "Disable";
    case BUCKET_NAMESPACE_ENABLE:
      return out << "Enable";
    default:
      return out << "Unknown";
  }
...
WRITE_CLASS_ENCODER(RGWBucketSyncConf)
...
struct RGWBucketInfo {
  ...
  rgw_user owner;
  uint32_t flags;
  map<string, bool> disable_sync;
  map<string, bool> bilog_flags;
  string zonegroup;
  ...
  RGWBucketNamespaceType namespace_type = BUCKET_NAMESPACE_DISABLE;
  ...
  map<string, RGWBucketSyncConf> sync_config;
  ...
  void encode(bufferlist& bl) const {
     ...
     encode((uint32_t)namespace_type, bl);
     encode(disable_sync, bl);
     encode(bilog_flags, bl);
     encode(sync_config, bl);
     if (obj_lock_enabled()) {
       encode(obj_lock, bl);
     }
     encode(storage_class, bl);
     encode(encryption_algorithm, bl);
     encode(kms_master_key_id, bl);
     encode(bos_obj_lock, bl);
     encode(trash_dir, bl);
     ENCODE_FINISH(bl);
  }
  void decode(bufferlist::iterator& bl) {
    DECODE_START_LEGACY_COMPAT_LEN_32(26, 4, 4, bl);
     decode(bucket, bl);
     if (struct_v >= 2) {
       string s;
       decode(s, bl);
     ...
     if (struct_v >= 20) {
       uint32_t nt;
       decode(nt, bl);
       namespace_type = (RGWBucketNamespaceType)nt;
     } else {
       namespace_type = BUCKET_NAMESPACE_DISABLE;
     }
     if (struct_v >= 21) {
       decode(disable_sync, bl);
       decode(bilog_flags, bl);
       decode(sync_config, bl);
     }
     if (struct_v >= 22 && obj_lock_enabled()) {
       decode(obj_lock, bl);
     }
     if (struct_v >= 23) {
     ...
     if (struct_v >= 24) {
       decode(encryption_algorithm, bl);
       decode(kms_master_key_id, bl);
     }
     if (struct_v >= 25) {
      decode(bos_obj_lock, bl);
     }
     if (struct_v >= 26) {
       decode(trash_dir, bl);
     }
  ...
  bool datasync_flag_enabled(const string& zone) const {
    auto iter = disable_sync.find(zone);
    if (iter == disable_sync.end())
      return true;
    return !iter->second;
  }
  bool bilog_started(const string& zone) const {
    auto iter = bilog_flags.find(zone);
    if (iter == bilog_flags.end())
      return true;
    return iter->second;
  }
...
#ifdef WITH_BCEBOS
  map<string, string> x_exclude_bce_meta_map;
#endif
...
struct rgw_obj_key {
  ...
  rgw_obj_key(const string_view& n) : name(n) {}
...
struct req_state {
  ...
  /* For request to check whether user is an iam user. */
  bool iam_check_user{false};
  ...
  /**/
  bool is_symlink_obj{false};
  uint64_t symlink_size_in{0};
  uint64_t symlink_size_out{0};
  ...
  void *asio_ctx{nullptr};
  bufferlist response_body;

  std::string explicit_content_type;
  ...
  inline bool is_from_platform_frontend() {
    const char* custom_user_agent = info.env->get("HTTP_X_AMZ_USER_AGENT");
    if (custom_user_agent &&
        string_view(custom_user_agent).find("abcstorage") != string::npos) {
      return true;
    }
    return false;
  }
...
extern string rgw_trim_character(const string& src, const char& delimiter);
extern string rgw_trim_enter(const string& src);
...
static inline string rgw_bl_to_str(ceph::buffer::list& raw)
{
...
class ConnectionPool {
  string _host;
  uint32_t _port;
  int _total_sock_number;
  int _free_sock_count;
  int _conn_retry;
  bool _use_asio;
  ...
  sock_info_t* _sock_arr;
  int find_free_socket();
  int async_find_free_socket(int* idx, void* sync_inject = nullptr);
  int _check_connection(int idx);
  int try_connect(int idx);
  int _fetch_socket(int& old_status, void* sync_inject = nullptr);
  int _free_socket(int idx, bool close);
protected:
  enum Status{
    CPS_BUSY=0,
    CPS_READY=1,
...
public:
  ConnectionPool(boost::asio::io_context& ioc, string host, string port, int socks_num, int conn_retry, bool use_asio)
    : _host(std::move(host)), _port(stoi(port)), _total_sock_number(socks_num),
      _conn_retry(conn_retry), _use_asio(use_asio), _pipe(ioc) {
    if (socks_num <= 0 || conn_retry <= 0) {
      return;
    }
    if (_sock_arr) {
      free(_sock_arr);
    ...
    _sock_arr = (sock_info_t*)calloc(socks_num, sizeof(sock_info_t));
    if (!_sock_arr) {
      return;
    }
    ...
    for (int i = 0; i < socks_num; ++i) {
      _sock_arr[i].stream = std::make_shared<boost::asio::ssl::stream<tcp::socket> >(ioc, context);
      _sock_arr[i].status = CPS_INVALID;
    }
    //_total_sock_number = socks_num;
    _free_sock_count = socks_num;
    for (int i = 0; i < socks_num; i++) {
      _pipe.write_some(boost::asio::mutable_buffer(&i, sizeof(int)));
    }
  }
  ~ConnectionPool() {};
  int fetch_socket(std::shared_ptr<boost::asio::ssl::stream<tcp::socket> >& stream, void** asio_ctx = nullptr);
  int free_socket(int idx);
  int reopen_socket(int idx);
};
...
public:
    ...
    T loc;
    IO(){}
    IO(librados::AioCompletion* _c, string _oid, T& _loc) 
      : c(_c), oid(_oid), loc(_loc){}
  };

  deque<IO> ios;
  vector<T>* ref_objs = nullptr;

#define RGW_MAX_AIO_DEFAULT 10
  size_t max_aio{RGW_MAX_AIO_DEFAULT};

public:
  RGWIOManager(CephContext *_cct, size_t _max_aio = RGW_MAX_AIO_DEFAULT) : cct(_cct), max_aio(_max_aio) {}
  RGWIOManager(CephContext *_cct, vector<T>* _ref_objs = nullptr, size_t _max_aio = RGW_MAX_AIO_DEFAULT) : 
                cct(_cct), ref_objs(_ref_objs), max_aio(_max_aio) {}
  ~RGWIOManager() {
    for (auto io : ios) {
      io.c->release();
    }
  ...
  int schedule_io(librados::IoCtx *ioctx, const string& oid, librados::ObjectWriteOperation *op, T loc,
                  bool is_head_obj = false, bool skip_cache = false);
  int handle_next_completion();
  int drain_ios();
};

template <class T>
int RGWIOManager<T>::schedule_io(librados::IoCtx *ioctx, const string& oid, librados::ObjectWriteOperation *op, T loc,
  bool is_head_obj, bool skip_cache) {
  int ret = 0;
  while (ios.size() > max_aio)
  {
    ret = handle_next_completion();
    if (ret < 0)
    {
      return ret;
    }
  ...
  librados::AioCompletion *c = librados::Rados::aio_create_completion(NULL, NULL, NULL);
  if (is_head_obj) {
  ...
  ios.push_back(IO{c, oid, loc});

  return 0;
}

template <class T>
int RGWIOManager<T>::handle_next_completion()
{
  assert(!ios.empty());
  IO &io = ios.front();
  io.c->wait_for_safe();
...
template <class T>
int RGWIOManager<T>::drain_ios()
{
  int ret = 0;
  while (!ios.empty())
  {
    int r = handle_next_completion();
    if (r < 0)
    {
      ret = r; // return the last error
    }
  }
  return ret;
}

inline bool satisfy_worm_debug_time(CephContext* cct,
                                    const ceph::real_time& mtime,
                                    const ceph::real_time& retain_date) {
  if (cct->_conf->rgw_worm_debug_interval <= 0)
    return false;
  int64_t interval = (time(nullptr) - ceph::real_clock::to_time_t(mtime))
                      * 86400 / cct->_conf->rgw_worm_debug_interval;
  if ( ( interval + ceph::real_clock::to_time_t(mtime) ) <=
         ceph::real_clock::to_time_t(retain_date)) {
    return false;
  }
  return true;
}

extern int verify_object_lock(CephContext* cct,
...
namespace {
template<typename F>
void retry_send_request_by_connection_pool(const req_state* s,
                                           int& op_ret,
                                           ConnectionPool& connection_pool,
                                           int idx,
                                           const F& f) {
  int retry_num = s->cct->_conf->rgw_abcstore_proxy_connect_retry;
  do {
    --retry_num;
    if (op_ret == -ECONNRESET) {
      if (connection_pool.reopen_socket(idx) < 0) {
        std::this_thread::sleep_for(std::chrono::milliseconds(100));
        continue;
      }
    }
    op_ret = f();
  } while (op_ret == -ECONNRESET && retry_num > 0);
}
}

#endif
increase(perfcount_total_reqs{perfcount="rgw1"}[1m])
