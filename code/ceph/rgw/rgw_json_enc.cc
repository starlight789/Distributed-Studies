...
void RGWObjManifest::dump(Formatter *f) const
{
  ...
  ::encode_json("skip_cache", skip_cache, f);
...
void RGWUserInfo::dump(Formatter *f) const
{
  ...
  if (admin) { /* no need to show it for every user */
    encode_json("admin", (bool)admin, f);
  }
  encode_json("default_placement", default_placement.to_str(), f);
  encode_json("placement_tags", placement_tags, f);
  encode_json("bucket_quota", bucket_quota, f);
  encode_json("user_quota", user_quota, f);
  encode_json("qps_limit", qps, f);
  encode_json("bandwidth_limit", bandwidth, f);
...
void RGWUserInfo::decode_json(JSONObj *obj)
{
  ...
  bool adm = false;
  JSONDecoder::decode_json("admin", adm, obj);
  admin = (__u8)adm;
  ...
  JSONDecoder::decode_json("qps_limit", qps, obj);
  JSONDecoder::decode_json("bandwidth_limit", bandwidth, obj);
...
void RGWQuotaInfo::dump(Formatter *f) const
{
  ...
  if (max_size > 0) {
    ...
    f->dump_int("max_size_kb", -rgw_rounded_kb(abs(max_size)));
  }
...
void RGWBucketWebsiteConf::decode_json(JSONObj *obj) {
  JSONDecoder::decode_json("index", index_doc_suffix, obj);
  JSONDecoder::decode_json("notFound", error_doc, obj);
}

void RGWBucketSyncConf::dump(Formatter *f) const
{
  encode_json("zone", zone, f);
  encode_json("start_sync_time", start_sync_time, f);
  encode_json("stop_sync_time", stop_sync_time, f);
  encode_json("is_delay", is_delay, f);
}

void RGWBucketSyncConf::decode_json(JSONObj *obj) {
  JSONDecoder::decode_json("zone", zone, obj, true);
  JSONDecoder::decode_json("start_sync_time", start_sync_time, obj, true);
  JSONDecoder::decode_json("stop_sync_time", stop_sync_time, obj, true);
  JSONDecoder::decode_json("is_delay", is_delay, obj, true);
}

static void bucket_info_dump_sync_config(const char *name, const RGWBucketSyncConf& conf, Formatter *f, void *parent)
{
  conf.dump(f);
}
...
void RGWBucketInfo::dump(Formatter *f) const
{
  ...
  encode_json("placement_rule", head_placement_rule, f);
  ...
  encode_json("namespace_type", (uint32_t)namespace_type, f);
  encode_json("mdsearch_config", mdsearch_config, f);
  encode_json("reshard_status", (int)reshard_status, f);
  encode_json("new_bucket_instance_id", new_bucket_instance_id, f);
  encode_json("disable_sync", disable_sync, f);
  encode_json("bilog_flags", bilog_flags, f);
  encode_json_map("sync_config", "zone_id", NULL, NULL, bucket_info_dump_sync_config,(void *)this, sync_config, f);
  encode_json("object_lock", obj_lock, f);
  encode_json("storage_class", storage_class, f);
  encode_json("encryption_algorithm", encryption_algorithm, f);
  encode_json("kms_master_key_id", kms_master_key_id, f);
  encode_json("bos_object_lock", bos_obj_lock, f);
  encode_json("trash_dir", trash_dir, f);
}

static void decode_bucket_sync_config(map<string, RGWBucketSyncConf>& m, JSONObj *o)
{
  RGWBucketSyncConf c;
  string zone_id;
  JSONDecoder::decode_json("zone_id", zone_id, o);
  c.decode_json(o);
  m[zone_id] = c;
}
...
void RGWBucketInfo::decode_json(JSONObj *obj) {
  ...
  JSONDecoder::decode_json("placement_rule", head_placement_rule, obj);
  ...
  uint32_t nt;
  JSONDecoder::decode_json("namespace_type", nt, obj);
  ...
  JSONDecoder::decode_json("disable_sync", disable_sync, obj);
  JSONDecoder::decode_json("bilog_flags", bilog_flags, obj);
  JSONDecoder::decode_json("sync_config", sync_config, decode_bucket_sync_config, obj);
  reshard_status = (cls_rgw_reshard_status)rs;
  JSONDecoder::decode_json("object_lock", obj_lock, obj);
  JSONDecoder::decode_json("storage_class", storage_class, obj);
  JSONDecoder::decode_json("encryption_algorithm", encryption_algorithm, obj);
  JSONDecoder::decode_json("kms_master_key_id", kms_master_key_id, obj);
  JSONDecoder::decode_json("bos_object_lock", bos_obj_lock, obj);
  JSONDecoder::decode_json("trash_dir", trash_dir, obj);
}
...
void RGWZonePlacementInfo::dump(Formatter *f) const
{
  ...
  encode_json("data_extra_pool", data_extra_pool, f);
  encode_json("tail_pools", tail_pools, f);
  encode_json("index_type", (uint32_t)index_type, f);
...
void RGWZonePlacementInfo::decode_json(JSONObj *obj)
{
  ...
  if (ppool || pcompression) {
    storage_classes.set_storage_class(RGWStorageClass::STANDARD, ppool, pcompression);
  }
}
...
void RGWZoneParams::decode_json(JSONObj *obj)
{
  ...
  JSONDecoder::decode_json("realm_id", realm_id, obj);
  JSONDecoder::decode_json("start_sync_time", start_sync_time, obj);
  JSONDecoder::decode_json("stop_sync_time", stop_sync_time, obj);
...
void RGWCORSRule::decode_json(JSONObj* obj) {
  JSONDecoder::decode_json("allowedOrigins", allowed_origins, obj);
  JSONDecoder::decode_json("allowedHeaders", allowed_hdrs, obj);
  JSONDecoder::decode_json("allowedExposeHeaders", exposable_hdrs, obj);
}
