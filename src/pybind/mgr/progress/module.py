...
# number of past completed events to remember
MAX_COMPLETED_EVENTS = 50
...
class Module(MgrModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._max_completed_events = MAX_COMPLETED_EVENTS
    ...
    def _prune_completed_events(self):
        ...
        if l > self._max_completed_events:
            self._completed_events = self._completed_events[l - self._max_completed_events : l]
            self._dirty = True
