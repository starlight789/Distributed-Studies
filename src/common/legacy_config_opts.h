...
OPTION(license_addr_ip, OPT_STR)
OPTION(license_addr_port, OPT_U32)
OPTION(license_offline_error, OPT_U32)
OPTION(license_expire_warn, OPT_U32)
OPTION(license_expire_error, OPT_U32)

// slow disk check
OPTION(mon_slow_disk_check_enable_drop_disk, OPT_BOOL)
OPTION(osd_slow_disk_check_enable, OPT_BOOL)
OPTION(osd_slow_disk_check_level1_hdd, OPT_DOUBLE)
OPTION(osd_slow_disk_check_level1_ssd, OPT_DOUBLE)
OPTION(osd_slow_disk_check_level1_nvme, OPT_DOUBLE)
OPTION(osd_slow_disk_check_level2_hdd, OPT_DOUBLE)
OPTION(osd_slow_disk_check_level2_ssd, OPT_DOUBLE)
OPTION(osd_slow_disk_check_level2_nvme, OPT_DOUBLE)
OPTION(osd_slow_disk_check_min_period, OPT_U32)
OPTION(osd_slow_disk_check_warn_interval, OPT_U32)
OPTION(osd_slow_disk_check_warn_long_interval, OPT_U32)
OPTION(osd_slow_disk_check_drop_interval, OPT_U32)
OPTION(osd_slow_disk_warn_percent, OPT_U32)
OPTION(osd_slow_disk_warn_long_percent, OPT_U32)
OPTION(osd_slow_disk_drop_percent, OPT_U32)
OPTION(osd_slow_disk_min_ops_each_period, OPT_U32)
OPTION(osd_slow_disk_drop_osd_max_pool_used_percent, OPT_FLOAT)
OPTION(osd_slow_disk_debug_inject_slow_op, OPT_BOOL)
OPTION(osd_slow_disk_debug_inject_slow_op_range_start, OPT_DOUBLE)
OPTION(osd_slow_disk_debug_inject_slow_op_range_end, OPT_DOUBLE)
OPTION(osd_slow_disk_debug_inject_slow_op_percent, OPT_U32)
...
OPTION(osd_calc_pg_upmaps_aggressively, OPT_BOOL)
OPTION(osd_calc_pg_upmaps_aggressively_fast, OPT_BOOL)
OPTION(osd_calc_pg_upmaps_local_fallback_retries, OPT_U64)
...
OPTION(objectstore_cache_shard_num, OPT_INT)

OPTION(try_osd_merge_ops, OPT_BOOL)
OPTION(osd_merge_batch_max_size, OPT_INT)
OPTION(osd_debug_merge_inject_read_error, OPT_INT)
OPTION(osd_debug_merge_inject_write_error, OPT_INT)
...
OPTION(osd_delete_sleep, OPT_FLOAT)         // seconds to sleep between delete pgs
OPTION(osd_delete_sleep_ssd, OPT_FLOAT)
OPTION(osd_delete_sleep_hdd, OPT_FLOAT)
OPTION(osd_delete_sleep_hybrid, OPT_FLOAT)
...
OPTION(osd_scrub_unittest, OPT_BOOL) // for unittest to handle scrub,deep_scrub, repair
...
OPTION(osd_debug_inject_op_timeout, OPT_U32)
OPTION(osd_debug_inject_op_timeout_percentage, OPT_U32)
OPTION(osd_client_op_timeout, OPT_U32)

// recovery time
OPTION(osd_recovery_begin_time, OPT_STR)
OPTION(osd_recovery_end_time, OPT_STR)
OPTION(osd_recovery_begin_weekday, OPT_U32)
OPTION(osd_recovery_end_weekday, OPT_U32)
OPTION(osd_backfill_begin_time, OPT_STR)
OPTION(osd_backfill_end_time, OPT_STR)
OPTION(osd_backfill_begin_weekday, OPT_U32)
OPTION(osd_backfill_end_weekday, OPT_U32)
OPTION(osd_recovery_skip_time_limit_when_degraded, OPT_BOOL)
OPTION(osd_backfill_skip_time_limit_when_degraded, OPT_BOOL)

// auto adjust recovery speed
OPTION(osd_recovery_speed_self_adaption, OPT_BOOL) // enable auto-adjust recovery speed
OPTION(osd_recovery_speed_adaption_period, OPT_U32)
OPTION(osd_recovery_speed_increase_read_hdd, OPT_U32)
OPTION(osd_recovery_speed_increase_read_sata_ssd, OPT_U32)
OPTION(osd_recovery_speed_increase_read_nvme, OPT_U32)
OPTION(osd_recovery_speed_increase_write_hdd, OPT_U32)
OPTION(osd_recovery_speed_increase_write_sata_ssd, OPT_U32)
OPTION(osd_recovery_speed_increase_write_nvme, OPT_U32)
OPTION(osd_recovery_speed_increase_rwrite_hdd, OPT_U32)
OPTION(osd_recovery_speed_increase_rwrite_sata_ssd, OPT_U32)
OPTION(osd_recovery_speed_increase_rwrite_nvme, OPT_U32)
OPTION(osd_recovery_speed_decrease_read_hdd, OPT_U32)
OPTION(osd_recovery_speed_decrease_read_sata_ssd, OPT_U32)
OPTION(osd_recovery_speed_decrease_read_nvme, OPT_U32)
OPTION(osd_recovery_speed_decrease_write_hdd, OPT_U32)
OPTION(osd_recovery_speed_decrease_write_sata_ssd, OPT_U32)
OPTION(osd_recovery_speed_decrease_write_nvme, OPT_U32)
OPTION(osd_recovery_speed_decrease_rwrite_hdd, OPT_U32)
OPTION(osd_recovery_speed_decrease_rwrite_sata_ssd, OPT_U32)
OPTION(osd_recovery_speed_decrease_rwrite_nvme, OPT_U32)
// gap of each step
OPTION(osd_recovery_gap_sleep, OPT_FLOAT)
OPTION(osd_max_backfills_gap, OPT_U32)
OPTION(osd_recovery_max_active_gap, OPT_U32)
// the max values of recovery when set auto-adjust recovery speed
OPTION(osd_recovery_adaption_max_backfills, OPT_U32)
OPTION(osd_recovery_adaption_max_active, OPT_U32)
OPTION(osd_recovery_adaption_lowest_sleep, OPT_FLOAT)
// limit the minimum speed of recovery
OPTION(osd_recovery_adaption_min_backfills, OPT_U32)
OPTION(osd_recovery_adaption_min_active, OPT_U32)
OPTION(osd_recovery_adaption_max_sleep, OPT_FLOAT)

// pause recovery when the osd have client requests
OPTION(osd_recovery_pause_when_client_op_inflight, OPT_BOOL)
OPTION(osd_recovery_pause_max_iops, OPT_U32)
...
OPTION(rocksdb_high_pri_pool_ratio, OPT_FLOAT)  // default rocksdb high priority cache ratio
OPTION(rocksdb_cache_strict_capacity_limit, OPT_BOOL)
...
OPTION(rocksdb_delete_range_threshold, OPT_U32)
...
OPTION(bdev_poweroff_safe, OPT_BOOL)
OPTION(bdev_poweroff_force_flush_interval, OPT_U32)
...
OPTION(bluestore_volume_selection_db_reserved, OPT_U64)
...
OPTION(bluestore_deferred_write_min_percentage, OPT_U32)
...
OPTION(bluestore_force_use_buffer_io, OPT_BOOL)
...
OPTION(bluestore_shard_finishers, OPT_INT)
...
OPTION(rgw_rados_read_flag, OPT_INT)
...
OPTION(rgw_bucket_namespace_enable, OPT_BOOL)
OPTION(rgw_bucket_namespace_disable_force, OPT_BOOL)
OPTION(rgw_namespace_head_cheap, OPT_BOOL)
OPTION(rgw_namespace_disable_object_policy, OPT_BOOL)
...
OPTION(rgw_enable_skip_cachepool, OPT_BOOL)   // rgw can skip cache pool to operate obj in data pool directly
OPTION(rgw_file_shuntflow_size, OPT_INT)   // rgw default enable file shuntflow
...
OPTION(rgw_lc_thread_delay, OPT_INT) // Delay after processing of bucket listing chunks
...
OPTION(rgw_s3_url_prefix, OPT_STR) // entry point for which a url is considered a s3 url
...
/* bce IAM parameter strings */
/* rgw_s3_auth_use_iam  use IAM for RGW auth? */
OPTION(rgw_s3_auth_use_iam, OPT_BOOL)

OPTION(rgw_admin_entry, OPT_STR)  // entry point for which a url is considered an admin request
OPTION(rgw_bos_url_prefix, OPT_STR)
...
OPTION(rgw_readop_usage_whitelist, OPT_STR) // whitelist of remote client for readop usage.
...
OPTION(rgw_access_log_file, OPT_STR) // path to print access log
...
OPTION(rgw_usage_entry_add_threshold, OPT_INT)  // threshold to add usage log entry
...
OPTION(rgw_usage_log_tick_trim_interval, OPT_INT) // trim pending log data every X seconds
OPTION(rgw_usage_log_trim_time_wait, OPT_INT) // wait time before usage log trimmed
OPTION(rgw_usage_log_readop_trim_time_wait, OPT_INT) // wait time before readop usage log trimmed
...
OPTION(rgw_use_bos_bucket_names, OPT_BOOL) // enable bos bucket name rules
OPTION(rgw_encrypt_ip_into_request_id, OPT_BOOL) // encrypt reqeust id, same with bos
...
OPTION(rgw_bucket_clear_max_aio, OPT_INT)
...
OPTION(rgw_num_async_request_threads, OPT_INT) // num of threads to use for async request operations
...
OPTION(rgw_crypt_enable, OPT_BOOL) // enable used encrypt
...
OPTION(rgw_list_max_attempt_times, OPT_U32) // Max attempt times for ordered list objects
...
OPTION(rgw_delay_remove_head_obj, OPT_BOOL)
OPTION(rgw_node_bandwidth_limit, OPT_INT)
OPTION(rgw_node_qps_limit, OPT_INT)
OPTION(rgw_enable_list_rgw, OPT_BOOL)
OPTION(rgw_append_timeout, OPT_U64)

/* rgw proxy config */
OPTION(rgw_abcstore_proxy_address, OPT_STR)
OPTION(rgw_abcstore_proxy_connect_number, OPT_INT)
OPTION(rgw_abcstore_proxy_connect_retry, OPT_INT)
OPTION(rgw_worm_debug_interval, OPT_INT)  // Debug worm interval in seconds, represent for one day
OPTION(rgw_bos_worm_expiration_time, OPT_INT)

OPTION(rgw_bos_monitor_address, OPT_STR)
OPTION(rgw_bos_monitor_connect_number, OPT_INT)
OPTION(rgw_default_location, OPT_STR)
OPTION(rgw_play_service, OPT_STR)
OPTION(rgw_with_bcm_restrict, OPT_BOOL)
OPTION(rgw_iam_admin_read_ak, OPT_STR)
OPTION(rgw_iam_admin_read_sk, OPT_STR)
OPTION(rgw_max_copy_obj_concurrent_io, OPT_INT)
OPTION(rgw_bos_format_access_log, OPT_BOOL)

/* rgw kms config */
OPTION(rgw_kms_address, OPT_STR)
OPTION(rgw_kms_connect_number, OPT_INT)
OPTION(rgw_kms_connect_retry, OPT_INT)
OPTION(rgw_kms_admin_user, OPT_STR)

/* rgw multi region */
OPTION(rgw_abcstore_multi_region, OPT_BOOL)

OPTION(rgw_default_api_bos, OPT_BOOL)
OPTION(rgw_mirror_data_window_size, OPT_INT) // window size of cache in bytes for mirrror data
OPTION(rgw_mirror_url_blacklist, OPT_STR)        // blacklist url to mirror configuration

/* rgw multisite */
OPTION(rgw_sync_bucket_clear_interval_sec, OPT_INT)
OPTION(rgw_sync_bucket_clear_bypass_gc, OPT_BOOL) // enable/disable bypass gc when slave clear bucket
OPTION(rgw_multisite_bucket_clear_flag, OPT_BOOL)
OPTION(rgw_signature_v4, OPT_BOOL) // Signature request with AWS version 4

/* trash */
OPTION(rgw_default_trash_dir, OPT_STR)
