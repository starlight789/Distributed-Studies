...
const char *ceph_osd_state_name(int s)
{
    ...
    case CEPH_OSD_NOOUT:
        return "noout";
    case CEPH_OSD_LICENSE_OFFLINE:
        return "licenseoffline";
    case CEPH_OSD_LICENSE_OFFLINE_LONG:
        return "licenseofflinelong";
    case CEPH_OSD_LICENSE_NEAR_EXPIRE:
        return "licensenearexpire";
    case CEPH_OSD_LICENSE_SOON_EXPIRE:
        return "licensesoonexpire";
    default:
        return "???";
    }
}
