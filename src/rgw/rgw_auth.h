...
public:
  ...
  virtual bool is_iam_applier() const {return false;} /* out */
};
...
#ifdef WITH_BCEIAM
  std::vector<uint8_t> local_first_auth_stack;
#endif
...
public:
  ...
  virtual bool is_iam_applier() const {return info.iam_user;} /* out */
