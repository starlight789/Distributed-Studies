...
public:
  ...
  void to_xml(ostream& out);
  int rebuild_with_bos(RGWRados *store, ACLOwner *owner, RGWAccessControlPolicy& dest);
  ...
  int create_from_headers(RGWRados *store, struct req_state *s, ACLOwner& _owner);
};
