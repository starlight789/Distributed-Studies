...
public:
  ...
  virtual RGWCoroutine *sync_object(RGWDataSyncEnv *sync_env, RGWBucketInfo& bucket_info, rgw_obj_key& key, real_time& mtime, std::optional<uint64_t> versioned_epoch, rgw_zone_set *zones_trace) = 0;
