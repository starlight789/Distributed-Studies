...
extern int cls_cxx_map_get_vals_v1(cls_method_context_t hctx, const string &start_obj,
...
extern int cls_cxx_map_remove_key(cls_method_context_t hctx,
                                  const string &key,
                                  bool skip_cache=false);
extern int cls_cxx_map_remove_keys(cls_method_context_t hctx,
...
extern bool cls_check_oid_exist(cls_method_context_t hctx);
