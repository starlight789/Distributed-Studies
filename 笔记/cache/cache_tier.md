...
# 3. IO
![](/笔记/image/cache/cache-process.png)  
- WriteBack 策略：
![](/笔记/image/cache/WriteBackProcess.png)  
- 针对其中涉及到的几个封装好的方法的操作： do_cache_redirect， do_proxy_read， do_proxy_write, promote_object
![](/笔记/image/cache/proxy-read.png)  
